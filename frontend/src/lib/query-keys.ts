export const QueryKeys = {
	apartments: {
		...
		list: (filters: string) =>
			[...QueryKeys.apartments.lists(), { filters }] as const,
		details: () => [...QueryKeys.apartments.all, "detail"] as const,
		detail: (id: string | number) =>
			[...QueryKeys.apartments.details(), id] as const,
	},
	buildings: {
